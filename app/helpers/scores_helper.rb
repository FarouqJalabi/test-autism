module ScoresHelper
  ...
  def percentage_to_header(percentage)
    t("result.fullLabel"+get_test_bracket(percentage).to_s)
  end

  def percentage_to_label(percentage)
    t("result.label"+get_test_bracket(percentage).to_s)
  end

  def percentage_to_description(percentage)
    t("result.description"+get_test_bracket(percentage).to_s)
  end
